...
class Network(object):
    ...
    def create_architecture(self, sess, mode, num_classes, tag=None, anchor_scales=(8, 16, 32), anchor_ratios=(0.5, 1, 2)):
        ...
        with arg_scope([slim.conv2d, slim.conv2d_in_plane,
            ...
            rois, cls_prob, bbox_pred ,fc7= self.build_network(sess, training)
    ...
    def test_image(self, sess, image, im_info):
        ...
        cls_score, cls_prob, bbox_pred, rois,feat = sess.run([self._predictions["cls_score"],
                                                                self._predictions['cls_prob'],
                                                                self._predictions['bbox_pred'],
                                                                self._predictions['rois'],
                                                                self._predictions['fc7']],
                                                               feed_dict=feed_dict)
        return cls_score, cls_prob, bbox_pred, rois,feat
